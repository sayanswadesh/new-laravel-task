            ...
            <div class="tab-content">
                <form id="profile_form" class="form-horizontal dashed-row white-field" action="{{route('saveGeneralProfile')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Full Name<span class="requiredAsterisk">*</span></label>
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control" id="inputName" placeholder="Enter name" value="{{Auth::user()->name}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="mobile" class="form-control" id="inputMobile" placeholder="Enter mobile" value="{{Auth::user()->phone}}">
                        </div>
                    </div>
                    <div class="form-group row">
